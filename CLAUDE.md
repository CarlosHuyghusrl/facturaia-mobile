...
This project is indexed by GitNexus as **FacturaScannerApp** (685 symbols, 879 relationships, 14 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
## CLIProxy — Gemini Flash (SOLO FacturIA)

gemini-2.5-flash fue removido de CLIProxy (puerto 8317) para todos los clientes.
FacturIA usa su propia API key directa de Google configurada en las env vars del container Docker.
NO usar CLIProxy para gemini-2.5-flash desde FacturIA.

(Actualizado: 2026-04-08 — restricción de cuota CLIProxy)
